...
public class AppBar {
	...
	public static void main(String[] args) throws IOException {
		...
		String title="各公司JEE AS市场占有量";
		JFreeChart chart=ChartFactory.createBarChart3D(title, "季度", "产量/万台", dataset, PlotOrientation.HORIZONTAL, true, false, false);
        //中文
		...
		ChartUtilities.saveChartAsJPEG(new File("e:\\bar.jpg"), chart, 800, 500);
	}
