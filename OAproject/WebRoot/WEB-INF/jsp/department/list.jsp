...
<div id="MainArea">
        ...
        <tbody id="TableData" class="dataContainer" datakey="departmentList">
        	...
        	<s:iterator value="#departmentList">
				...
				<tr class="TableDetail1 template">
					...
					<td>
					<!-- struts中只能用ognl表达式 不能用EL表达式
					     html中不能用ognl表达式 能用EL表达式
					 -->
						<s:a action="DepartmentAction_deleteDepById?did=%{did}">删除</s:a>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
            <a href="DepartmentAction_addUI"><img src="${pageContext.request.contextPath}/css/images/createNew.png" /></a>
        </div>
    </div>
</div>
