...
<head>
    ...
    <script type="text/javascript">
	     function showProcessImage( deploymentId ){
            var url ="pdmanagerAction_showProcessImage.action?did="+deploymentId;
            
            window.open(url,300,300);
        }
    </script> 
</head>
<body>
        ...
        <tbody id="TableData" class="dataContainer" datakey="processDefList">
        	<s:iterator value="#pdList">
				<tr class="TableDetail1 template">
						...
						<td><s:a action="pdmanagerAction_delete.action?key=%{pdkey}">删除</s:a>
            ...
            <table border="0" cellspacing="0" cellpadding="10" align="left">
                <tr>
			        <td><div class="FuncBtn">
                            ...
                            <div class=FuncBtnMemo><s:a action="pdmanagerAction_deployUI.action">部署流程定义文档</s:a></div>
