...
<DIV ID="addVersion" STYLE="margin-left: 3px; width: 700px; float: left;" border="3">
  ...
  <tr>
    ...
    <td width="540" bgcolor="#F0F7FD"><input id="title" name="" type="text" style="background-color: #FFFFFF;
  ...
  <tr>
    ...
    <td bgcolor="#F0F7FD"><textarea id="content" name="" cols="" rows="" style="background-color: #FFFFFF;
    border: 1px solid #91C0E3;
