    ...
    pFunction: {
        privilegeTree: {//所有的权限树的操作
            ...
            loadPrivilegeTree: function(){
                ...
                $.post("menuitemAction_showPrivilegeByUid.action", parameter, function(data){
                    privilege.pFunction.privilegeTree.zTree = $("#privilegeTree").zTree(privilege.pFunction.privilegeTree.setting, data.menuitemList);
                    /**
                     * 这里是设置全选按钮默认状态的最佳位置
            ...
            savePrivilege: function(){
            	...
            	$.post("menuitemAction_savePrivilege.action",parameter,function(data){
