				...
				<tbody>
					<s:iterator value="allLogs" status="st">
						<tr>
							...
							<td>
								<span title='<s:property value="operParams"/>'><s:property value="@surveypark.utils.StringUtil@getDescString(operParams)"/></span>
							</td>
							<td>
								<s:property value="operResult"/>
							</td>
							<td>
								<span title='<s:property value="resultMsg"/>'><s:property value="@surveypark.utils.StringUtil@getDescString(resultMsg)"/></span>
							</td>
							<td>
