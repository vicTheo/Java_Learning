		...
		<table>
				...
				<tr>
					<td colspan="2" style="text-align: left;display: inline">
						...
						<s:iterator value="qsm.question.matrixSelectOptionsArr" status="optst">
							<!-- 对文本框进行修饰,产生颜色块的特效 -->
				...
				<tr>
					<td>
						<table>
							...
							<tr>
								<td width="30px"></td>
								<s:iterator value="qsm.question.matrixColTitlesArr">
									<!-- 集合中每个元素都是字符串,直接通过s:property 方式输出 -->
									<td><s:property /></td>
								</s:iterator>
							</tr>
							<!-- 遍历行标题数组 -->
							<s:iterator var="row" value="qsm.question.matrixRowTitlesArr" status="rst">
								<tr>
									<td><s:property /></td>
									<!--  遍历列表数组 -->
									<s:iterator var="col" value="qsm.question.matrixColTitlesArr" status="cst">
										<td style="text-align: left;">
											<!-- 遍历下拉选项数组 -->
											<s:iterator var="option" value="qsm.question.matrixSelectOptionsArr" status="optst">
